...
const messages = defineMessages({
    ...
    storedOnBilup: {id: 'mw.projectMeta.storedOnBilup', defaultMessage: 'Stored on PineEditor'},
    ...
    bilupLimits: {id: 'mw.projectMeta.bilupLimits', defaultMessage: 'PineEditor allows 20 MB of compressed project data, 1 GB expanded, 50 MB of assets, and 10 MB per asset.'},
    ...
    signInToAddAuthor: {id: 'mw.projectMeta.signInToAddAuthor', defaultMessage: 'Sign in to PineEditor Accounts and save this project to add authorship.'},
...
const ProjectMetadataModal = ({initialView, intl, onRequestClose, projectTitle, roturUsername, vm}) => {
    ...
    const groups = [
        ...
        },
        {
            ...
            items: [
                {id: 'optimiser', label: intl.formatMessage({id: 'mw.projectMeta.storage', defaultMessage: 'PineEditor storage'}), icon: Gauge},
            ...
            <React.Fragment>
                <div className={styles.pageTitle}>
                    <div>
                        <Header>
                            <FormattedMessage
                                defaultMessage="PineEditor storage"
