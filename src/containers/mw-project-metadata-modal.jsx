...
const messages = defineMessages({
    ...
    bilupLimits: {id: 'mw.projectMeta.bilupLimits', defaultMessage: 'PineWarp allows 20 MB of compressed project data, 1 GB expanded, 50 MB of assets, and 10 MB per asset.'},
