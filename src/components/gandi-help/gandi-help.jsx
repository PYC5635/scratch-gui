            ...
            <div className={styles.panel} role="dialog" aria-label={isChinese ? "Gandi 帮助" : "Gandi Help"}>
                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.section}>
                        ...
                        <ol className={styles.steps}>
                            <li className={styles.step}>
                                {isChinese ? "在 PineWarp 编辑器中，开启高级设置中的实验性超级重构功能" : "In PineWarp Editor, enable the experimental Super Refactor feature in Advanced Settings"}
                            </li>
                            <li className={styles.step}>
                    ...
                    <div className={styles.multilangSection}>
                        ...
                        <p>When converting PineWarp extensions to Gandi projects for compatibility, the extensions are not correctly transpiled. Unable to unify the six editors for now, please rest assured, fellow vendors.</p>
                        ...
                        <p>Lors de la conversion des extensions PineWarp vers les projets Gandi pour des raisons de compatibilité, les extensions ne sont pas correctement transpilées. Impossible d'unifier les six éditeurs pour l'instant, soyez rassurés, chers concurrents.</p>
                        <p>Beim Kompatibilitäts-Transfer von PineWarp-Erweiterungen zu Gandi-Projekten werden die Erweiterungen nicht korrekt transpiliert. Vorübergehend können die sechs Editoren nicht vereinheitlicht werden, seien Sie unbesorgt, liebe Mitbewerber.</p>
                    </div>
                </div>
