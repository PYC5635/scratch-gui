                    ...
                    {hasKeys ? (
                        ...
                        <span className={styles.instruction}>
                            <FormattedMessage
                                ...
                                id="shortcut-manager.editorInstruction"
                            />
                        </span>
                    )}
                </div>
                ...
                <div className={styles.editorButtons}>
                    ...
                    >
                        <FormattedMessage
                            ...
                            id="shortcut-manager.editorClear"
                        />
                    </button>
                    <button
                ...
                <div className={styles.editorHint}>
                    {hasKeys ? (
                        lastKeyDown && Date.now() - lastKeyDown > 500 ? (
                            <FormattedMessage
                                defaultMessage="Press Enter to save or Escape to cancel"
                                id="shortcut-manager.editorSaveHint"
                            />
                        ) : null
                    ) : (
                        <FormattedMessage
                            defaultMessage="Press Backspace or Delete to clear"
                            id="shortcut-manager.editorClearHint"
                        />
                    )}
                </div>
            </div>
