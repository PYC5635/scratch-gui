...
const messages = defineMessages({
    ...
    presetRelaxed: {
        ...
        description: 'Relaxed performance budget preset',
        id: 'rw.devtools.budget.preset.relaxed'
    },
    presetBalanced: {
        defaultMessage: 'Balanced',
        description: 'Balanced performance budget preset',
        id: 'rw.devtools.budget.preset.balanced'
    },
    presetStrict: {
        defaultMessage: 'Strict',
        description: 'Strict performance budget preset',
        id: 'rw.devtools.budget.preset.strict'
    },
    presetCustom: {
        defaultMessage: 'Custom',
        description: 'Custom performance budget preset',
        id: 'rw.devtools.budget.preset.custom'
    },
    bytesSuffix: {
        defaultMessage: ' bytes',
        description: 'Unit suffix shown after a byte count',
        id: 'rw.devtools.budget.bytes'
    },
    threshold: {
                        ...
                        <label className={styles.devToolsLabel}>
                            ...
                            >
                                <option value="relaxed">
                                    {intl.formatMessage(messages.presetRelaxed)}
                                </option>
                                <option value="balanced">
                                    {intl.formatMessage(messages.presetBalanced)}
                                </option>
                                <option value="strict">
                                    {intl.formatMessage(messages.presetStrict)}
                                </option>
                                <option value="custom">
                                    {intl.formatMessage(messages.presetCustom)}
                                </option>
                            </select>
                        </label>
                                        ...
                                        <td>
                                            ...
                                            {metric === 'memory' ?
                                                <span className={styles.devToolsSuffix}>
                                                    {intl.formatMessage(messages.bytesSuffix)}
                                                </span> : null}
                                        </td>
                                        <td>
                                            <span
