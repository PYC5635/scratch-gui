...
import bilupLogo from './pine-logo.svg';
...
const twMessages = defineMessages({
    ...
    bilupHome: {
        ...
        defaultMessage: 'PineEditor home',
        description: 'Title for the home link in the menu bar'
    },
    bilupLogoAlt: {
        id: 'tw.menuBar.bilupLogoAlt',
        defaultMessage: 'PineEditor',
        description: 'Alt text for the PineEditor pineapple logo'
    },
    bilupWordmark: {
        id: 'tw.menuBar.bilupWordmark',
        defaultMessage: 'PineEditor',
        description: 'PineEditor brand wordmark text in the menu bar'
    },
    moreMenu: {
                                            ...
                                            {mistwarpAction ? (
                                                <MenuItem onClick={this.handleClickMistWarpShare}>
                                                    ...
                                                    {mistwarpAction === 'remix' ? (
                                                        <FormattedMessage
                                                            defaultMessage="Remix to PineEditor"
                                                            description="File menu item to remix a PineEditor project"
                                                            id="mw.menuBar.remix"
                                                        />
                                                    ) : (
                                                        <FormattedMessage
                                                            defaultMessage="Save to PineEditor"
                                                            description="File menu item to save the project to PineEditor"
                                                            id="mw.menuBar.share"
                                                        />
                                                    )}
                                                </MenuItem>
                                            ...
                                            {this.state.mistwarpProject ? (
                                                <MenuItem onClick={this.handleClickSeeMistWarpPage}>
                                                    ...
                                                    <FormattedMessage
                                                        ...
                                                        description="File menu item opening the PineEditor project page"
                        ...
                        >
                            ...
                            >
                                ...
                                <MenuSection>
                                    <MenuItem
                                        onClick={() => {
                                            if (window.__pinePerfToggle) {
                                                window.__pinePerfToggle();
                                            }
                                            this.props.onRequestCloseTools();
                                        }}
                                    >
                                        <Gauge />
                                        <FormattedMessage
                                            defaultMessage="性能分析器"
                                            description="PineEditor 性能分析器——分析积木耗时、复杂度与 GPU 占用率"
                                            id="pine.menuBar.perfAnalyzer"
                                        />
                                    </MenuItem>
                                </MenuSection>
                                ...
                                <MenuSection>
                                    <MenuItem
                                        onClick={() => {
                                            window.__pinePerfToggle && window.__pinePerfToggle();
                                            this.props.onRequestCloseTools();
                                        }}
                                    >
                                        <Gauge />
                                        <FormattedMessage
                                            defaultMessage="Performance Analyzer"
                                            description="Menu bar item to toggle the performance analyzer"
                                            id="tw.menuBar.performanceAnalyzer"
                                        />
                                    </MenuItem>
                                </MenuSection>
                                <MenuSection>
