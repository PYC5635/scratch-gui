...
const messages = defineMessages({
    ...
    removeWallpaper: {
        ...
        description: 'Button to remove the current wallpaper',
        id: 'mw.settings.removeWallpaper'
    }
});

const WallpaperMenuItem = ({url, isSelected, onClick, onRemove, intl}) => (
        ...
        <div className={styles.option}>
            ...
            {onRemove ? (
                <button
                    ...
                    title={intl.formatMessage(messages.removeWallpaper)}
                    aria-label={intl.formatMessage(messages.removeWallpaper)}
                    onClick={e => {
                        e.stopPropagation();
                        onRemove(url);
                    }}
