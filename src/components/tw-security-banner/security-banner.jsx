...
const messages = defineMessages({
    ...
    turboWarpBlog: {
        defaultMessage: 'TurboWarp blog',
        description: 'Link text pointing to the TurboWarp blog post',
        id: 'tw.securityBanner.turboWarpBlog'
    }
});
                        ...
                        <FormattedMessage 
                            ...
                            values={{
                                link: (
                                    ...
                                    >
                                        {intl.formatMessage(messages.turboWarpBlog)}
                                    </a>
                                )
                            }}
                        />
