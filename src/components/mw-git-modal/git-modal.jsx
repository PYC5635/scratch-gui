        ...
        return (
            <Box className={styles.section}>
                ...
                <Box className={styles.field}>
                    ...
                    <p className={styles.muted}>
                        <FormattedMessage
                            defaultMessage="Generate one at git.bilup.org → Settings → Applications → Generate new token. Required for API calls to PineWarp Git."
            ...
            return (
                <Box className={styles.emptyState}>
                    ...
                    <p>
                        <FormattedMessage
                            // eslint-disable-next-line max-len
                            defaultMessage="Sign in with PineWarp Accounts to create repos on git.bilup.org and push your project straight from PineWarp."
