...
const DEFAULT_DESCRIPTION =
    'PineEditor (🍍) is a blazing-fast visual programming editor based on MistWarp & TurboWarp. It adds a performance analyzer, cloud lists, multi-dimensional lists, advanced custom blocks and a Classical Chinese language mode.';
