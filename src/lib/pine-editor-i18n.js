/**
 * PineEditor 文言文语言包（Classical Chinese · 文言文）
 *
 * 提供两份词典：
 ...
 *
 * 并提供两个入口：
 *   - registerPineLocale(editorMessages): 把 `zh-wenyan` 语言注入 scratch-l10n 的消息表，
 *     使其可被 react-intl 选择。
...
export const CLASSICAL_UI = {
    ...
    'gui.menuBar.save': '存之',
    'gui.menuBar.share': '达于PineEditor',
    'gui.menuBar.file': '文档',
    'gui.menuBar.edit': '修订',
    ...
    'gui.menuBar.bilupHome': 'PineEditor里',
    'gui.menuBar.bilupLogoAlt': 'PineEditor',
    'gui.menuBar.bilupWordmark': 'PineEditor',
 ...
 * 以官方完整文言文 interface 为基底，再用 CLASSICAL_UI 补充 Bilup/PineEditor 独有的文案。
