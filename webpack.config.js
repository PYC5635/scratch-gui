...
const base = {
    ...
    resolve: {
        ...
        symlinks: true,
        // _sdeps-referenced scratch-* repos sit outside gui/node_modules, so exactly-once
        // webpack cannot walk to their deps. Fall back to this project's node_modules
        // so everything (scratch-vm, scratch-blocks, ...) resolves from a single store.
        modules: [
    ...
    module: {
        ...
        rules: [{
            ...
            include: [
                ...
                // _sdeps-hosted scratch-* / accounts-sdk repos also use modern syntax
                // (?? ?. class fields); transpile them so webpack can parse.
                path.resolve(__dirname, '..', '_sdeps'),
    ...
    defaultsDeep({}, base, {
        ...
        plugins: base.plugins.concat([
            ...
            new HtmlWebpackPlugin({
                ...
                title: `${APP_NAME} - Make creation blazing-fast 🍍`,
                isEditor: true,
